...
class FileSort3G {
     ...
     * @throws IOException ..
     */
    private void splitFiles(RandomAccessFile dest, RandomAccessFile firstFile,
                            RandomAccessFile secondFile) throws IOException {
        dest.seek(0);
     ...
     * @throws IOException ..
     */
    private void mergeFiles(RandomAccessFile firstFile, RandomAccessFile secondFile,
                            RandomAccessFile dest) throws IOException {
        dest.seek(0);
        firstFile.seek(0);
        secondFile.seek(0);
