...
public class UpdateServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        UserStore.getBase().updateUser(id, new User(name, login, email, date));
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        writer.append(
                ...
                req.getContextPath()).append("/update method='post'>").append(
                "Id:  <input type='text' name='id'").append("<br>").append(
                ...
                "/update method='get'>").append("<button type='submit'>Update records</button>").append(
