...
public class TriangleTest {
	...
	public void whenABCCorrectThenReturnArea() {
	  Triangle ABC_One=new Triangle(new Point(2.0,1.0), new Point (-1.0,-3.0), new Point(-1.0,1.0));
	...
	public void whenABCinLineThenReturnError() {
	  Triangle ABC_Two=new Triangle(new Point(1.0,1.0), new Point (5.0,5.0), new Point(10.0,10.0));
